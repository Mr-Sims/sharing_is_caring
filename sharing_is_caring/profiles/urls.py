...
from sharing_is_caring.profiles.views import UserProfileDetailsView, EditProfileView, foreign_profile_details, \
    CommentProfileView
...
urlpatterns = (
    ...
    path('profile/<int:pk>', foreign_profile_details, name='foreign profile details'),
